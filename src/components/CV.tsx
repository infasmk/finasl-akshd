      ...
      <section id="cv-contact" className="w-full bg-[#FAF9F5] border-t border-neutral-200/80 pt-16 pb-16">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5 space-y-4">
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-neutral-900 font-extralight tracking-tight uppercase leading-tight">
              LET'S CREATE SOMETHING EXCEPTIONAL
            </h2>
            <p className="font-sans text-xs text-neutral-500 font-light leading-relaxed max-w-sm">
          ...
          {/* Right Direct Studio Contact card: Compact & Tactile (Light Version for CV) */}
          <div className="lg:col-span-7 flex justify-center lg:justify-end items-center">
            <div className="w-full max-w-[440px] bg-[#FCFCFC] border-2 border-[#EAEAEA] p-6 md:p-7 relative shadow-xl shadow-neutral-100/60 rounded-xl overflow-hidden hover:border-[#C5A059]/40 transition-all duration-500 group">
              ...
              {/* Classic Golden Double Accent Corners */}
              ...
              <div className="border border-[#F2F2F2] rounded-lg p-5 bg-white relative z-10 space-y-6">
                ...
                <div className="flex justify-between items-start">
                  ...
                  {/* Fine logo graphic */}
                  <div className="border border-[#C5A059]/20 p-1 bg-[#FCFCFC] group-hover:border-[#C5A059]/50 transition-colors">
                ...
                <div className="pt-4 border-t border-neutral-100 space-y-3 font-bold">
                  <span className="font-mono text-[8px] tracking-widest text-[#B28B45] uppercase block">
                    CONNECTED PORTALS
                  </span>
